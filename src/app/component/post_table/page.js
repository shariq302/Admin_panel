...
const INITIAL_VISIBLE_COLUMNS = ["title", "recruiter", "location", "jobtype", "date", "salary", "experience", "status"];
  ...
  const filteredItems = React.useMemo(() => {
    ...
    if (hasSearchFilter) {
      filteredUsers = filteredUsers.filter((user) =>
        ...
        user.recruiter.toLowerCase().includes(filterValue.toLowerCase())
      );
    }
    if (
      statusFilter !== "all" &&
